...
class ArticalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artical" do
    assert_difference('Artical.count') do
      post articals_url, params: { artical: { content: @artical.content, title: @artical.title } }
    end
  ...
  test "should update artical" do
    patch artical_url(@artical), params: { artical: { content: @artical.content, title: @artical.title } }
